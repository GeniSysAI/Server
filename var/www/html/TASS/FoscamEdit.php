                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-heading">
                                ...
                                <i class="fa fa-cogs fa-fw"></i> Edit TASS Foscam #<?=filter_input(INPUT_GET,'device',FILTER_SANITIZE_NUMBER_INT); ?>
                            ...
                            <div class="panel-body">
                                ...
                                <form role="form" id="form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label>Update TASS Foscam iotJumpWay Device</label>
                                        <select id="deviceID" name="deviceID" class="form-control select-validate">
                                            ...
                                            <option value="<?=abs($devVal->id); ?>,<?=$devVal->device; ?>" <?=abs($devVal->id)==$tassFoscam["ResponseData"]["jid"] ? " selected " : ""; ?>><?=abs($devVal->id); ?>: <?=$devVal->device; ?></option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="RTSPuser" name="RTSPuser" class="form-control text-validate" value="<?=$tassFoscam["ResponseData"]["RTSPendpoint"] ? $_GeniSys->_helpers->decrypt($tassFoscam["ResponseData"]["RTSPuser"]) : ""; ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="RTSPpass" name="RTSPpass" class="form-control text-validate" value="<?=$tassFoscam["ResponseData"]["RTSPendpoint"] ? $_GeniSys->_helpers->decrypt($tassFoscam["ResponseData"]["RTSPpass"]) : ""; ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label>RTSPip</label>
                                        <input type="text" id="RTSPip" name="RTSPip" class="form-control text-validate" value="<?=$tassFoscam["ResponseData"]["RTSPendpoint"] ? $_GeniSys->_helpers->decrypt($tassFoscam["ResponseData"]["RTSPip"]) : ""; ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="RTSPport" name="RTSPport" class="form-control text-validate" value="<?=$tassFoscam["ResponseData"]["RTSPendpoint"] ? $_GeniSys->_helpers->decrypt($tassFoscam["ResponseData"]["RTSPport"]) : ""; ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="RTSPendpoint" name="RTSPendpoint" class="form-control text-validate" value="<?=$tassFoscam["ResponseData"]["RTSPendpoint"] ? $_GeniSys->_helpers->decrypt($tassFoscam["ResponseData"]["RTSPendpoint"]) : ""; ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label>Stream</label>
                                        <input type="text" id="Stream" name="Stream" class="form-control text-validate" value="<?=$tassFoscam["ResponseData"]["Stream"] ? $_GeniSys->_helpers->decrypt($tassFoscam["ResponseData"]["Stream"]) : ""; ?>">
                                        <p class="help-block">Stream for the TASS processed stream. (Encrypted in your database)</p>

                                    </div>
                                    
                                    <div class="form-group">

                                        <label>StreamPort</label>
                                        <input type="text" id="StreamPort" name="StreamPort" class="form-control text-validate" value="<?=$tassFoscam["ResponseData"]["StreamPort"] ? $_GeniSys->_helpers->decrypt($tassFoscam["ResponseData"]["StreamPort"]) : ""; ?>">
                                        <p class="help-block">Stream port for the TASS processed stream. (Encrypted in your database)</p>

                                    </div>

                                    <input type="hidden" id="ftype" name="ftype" value="updateTASSfoscam" /> 
                                    <input type="hidden" id="tassID" name="tassID" value="<?=$tassFoscam["ResponseData"]["id"]; ?>" /> 
